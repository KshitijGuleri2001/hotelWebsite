...
const Hotels = () => {
  return (
   ...
   <div className='w-full h-[90vh]'>
       <img src="https://images.pexels.com/photos/271624/pexels-photo-271624.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="" className='w-full h-full object-cover ' />
       
          <div className='max-w-[1140px] m-auto'>
            <div  className='absolute  top-[30%] w-full md:-[50%] max-w-[600px] h-full flex flex-col  text-white p-4'>
                <h1 className='font-bold text-8xl'>Hotels</h1>
...
<div class="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
    ...
    <div class="w-full h-64 lg:w-1/2 lg:h-auto">
        <img class="h-[500px] w-full object-cover" src="https://images.pexels.com/photos/8085334/pexels-photo-8085334.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="Winding mountain road"/>
    </div>
    <div
        ...
        <div class="flex flex-col p-12 md:px-16">
            <h2 class="text-2xl font-medium uppercase text-blue-400 lg:text-4xl">Hotels</h2>
            <p class="mt-4">
